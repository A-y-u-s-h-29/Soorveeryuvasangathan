...
const VolunteerForm = ({ onSubmit, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Handle duplicate AAK number error
            if (errorMessage.includes('AAK number already')) {
                setErrors(prev => ({ ...prev, aakNo: 'This AAK number is already registered' }));
            }
        } finally {
            setLoading(false);
        }
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8">
                    ...
                    <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
                        <p className="text-sm text-blue-800 flex items-start">
                            ...
                            <span>
                                * Fields are required. After registration, you will receive a unique ID card 
                                that can be downloaded and printed. Your data will be securely stored in our database.
                            </span>
                        </p>
                    </div>
                </form>
