          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <p className="text-2xl font-bold mb-2">शूरवीर युवा ट्रस्ट</p>
                <p className="text-gray-300">Shoorveer Yuva Trust</p>
                <p className="text-gray-400 text-sm mt-2">Empowering Youth, Building Communities</p>
              </div>
              
              <div className="text-center md:text-right">
                <p className="text-gray-300 mb-1">
                  <i className="fas fa-phone-alt mr-2"></i>
                  Contact: +91 99232 25066
                </p>
                <p className="text-gray-300 mb-1">
                  <i className="fas fa-envelope mr-2"></i>
                  contact@shoorveer.org
                </p>
            ...
            <div className="border-t border-gray-700 mt-6 pt-6 text-center">
              <p className="text-gray-500 text-sm">
                © {new Date().getFullYear()} शूरवीर युवा ट्रस्ट. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
